...
from snowflake_arctic_query import snowflake_answer


def app():
# title of the streamlit app
   st.title(f""":blue[Natural Language Query Against Snowflake Tables]""")

   st.image(r'C:\Users\004BEI744\IBM\Techathon\SF_ARCTIC\Images\Natural_SF.png', caption= None, width=500) 
...
# evaluating st.chat_input and determining if a question has been input
   if question := st.chat_input("Ask about your data stored in Snowflake Tables"):
