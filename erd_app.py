...
with open(r'C:\Users\004BEI744\IBM\Techathon\SF_ARCTIC\creds-sample.json') as f:
    connection_parameters = json.load(f)  
getsession = Session.builder.configs(connection_parameters).create()
...
# title of the streamlit app
   #st.header(f""":blue[Entity Relationship Diagram for Snowflake Tables]""")
   st.markdown(""" 
                # :blue[Entity Relationship Diagram for Snowflake Tables]
                """)
